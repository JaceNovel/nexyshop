...
use App\Http\Controllers\Api\AdminPartnerFinanceController;
use App\Http\Controllers\Api\AdminProductController;
use App\Http\Controllers\Api\AdminResellerController;
use App\Http\Controllers\Api\AdminSecurityController;
use App\Http\Controllers\Api\AdminTournamentRegistrationPdfController;
use App\Http\Controllers\Api\AdminVideoController;
use App\Http\Controllers\Api\AstralChallengeController;
use App\Http\Controllers\Api\BlogPostController;
use App\Http\Controllers\Api\BotManualFulfillmentController;
...
use App\Http\Controllers\Api\StartGgController;
...
Route::middleware(['api', 'throttle:api'])->group(function () {
    ...
    Route::get('/bot/manual-fulfillment-orders', [BotManualFulfillmentController::class, 'index'])->middleware('throttle:api');
    Route::post('/bot/manual-fulfillment-orders/{order}/notified', [BotManualFulfillmentController::class, 'markNotified'])->middleware('throttle:api');
    Route::post('/bot/manual-fulfillment-orders/{order}/complete', [BotManualFulfillmentController::class, 'complete'])->middleware('throttle:api');
    ...
    Route::get('/startgg/tournaments', [StartGgController::class, 'tournaments']);
    Route::get('/startgg/tournament', [StartGgController::class, 'tournament']);
    Route::get('/startgg/events/{eventId}', [StartGgController::class, 'event']);
    Route::get('/startgg/videogames', [StartGgController::class, 'videogames']);
    Route::get('/startgg/league', [StartGgController::class, 'league']);
    ...
    Route::post('/admin/access-attempt', [AdminSecurityController::class, 'reportUnauthorizedAccess'])->middleware('throttle:uid');
    Route::post('/auth/clerk/session', [ClerkAuthController::class, 'session'])->middleware('throttle:uid');
    Route::get('/products/{product}/reviews', [CommerceController::class, 'productReviews']);
    Route::get('/live-purchases', [CommerceController::class, 'livePurchases']);
    ...
    Route::get('/crypto/quote', [CryptoPaymentController::class, 'quote'])->middleware('throttle:api');
});
...
Route::middleware(['auth.reseller', 'throttle:api'])->prefix('reseller')->group(function () {
    ...
    Route::post('/panel/crypto-topup', [CryptoPaymentController::class, 'resellerIntent']);
    Route::post('/panel/loans', [ResellerApiController::class, 'requestLoan']);
    ...
    Route::get('/v1/freefire/redeem-codes', [ResellerApiController::class, 'redeemCodes']);
    Route::post('/v1/freefire/redeem-codes/claim', [ResellerApiController::class, 'claimRedeemCode'])->middleware('throttle:uid');
    Route::post('/v1/freefire/lookup', [ResellerApiController::class, 'freeFireLookup'])->middleware('throttle:uid');
...
Route::middleware(['auth:sanctum', 'throttle:api'])->group(function () {
    Route::get('/user/products/{product}', [ShopController::class, 'customerProduct']);
    Route::post('/orders', [ShopController::class, 'order']);
    Route::post('/payments/initiate', [PaymentController::class, 'initiate']);
    Route::get('/challenges/astral-esport', [AstralChallengeController::class, 'index']);
    Route::post('/challenges/astral-esport', [AstralChallengeController::class, 'store']);
    Route::post('/payments/wallet/topup', [PaymentController::class, 'initiateWalletTopup'])->middleware('throttle:uid');
    Route::post('/payments/crypto/intents', [CryptoPaymentController::class, 'customerIntent'])->middleware('throttle:uid');
    Route::get('/payments/crypto/intents/{intent}', [CryptoPaymentController::class, 'show']);
    ...
    Route::post('/startgg/registrations', [StartGgController::class, 'register'])->middleware('throttle:uid');
    ...
    Route::post('/products/{product}/reviews', [CommerceController::class, 'storeReview'])->middleware('throttle:uid');
    Route::get('/user/wallet', [CommerceController::class, 'wallet']);
    Route::get('/user/vip', [CommerceController::class, 'vip']);
    Route::get('/orders/{order}/tracking', [CommerceController::class, 'orderTracking']);
...
Route::middleware(['auth:sanctum', 'can:admin'])->prefix('admin')->group(function () {
    Route::get('/security/blocks', [AdminSecurityController::class, 'index']);
    Route::delete('/security/blocks', [AdminSecurityController::class, 'unblock']);
    ...
    Route::get('/reviews', [AdminCommerceController::class, 'reviews']);
    Route::patch('/reviews/{review}', [AdminCommerceController::class, 'updateReview']);
    Route::get('/vip', [AdminCommerceController::class, 'vip']);
    Route::patch('/vip/{level}', [AdminCommerceController::class, 'updateVipLevel']);
    Route::get('/wallets', [AdminCommerceController::class, 'wallets']);
    Route::post('/wallets/{user}/adjust', [AdminCommerceController::class, 'adjustWallet']);
    Route::patch('/orders/{order}/status', [AdminCommerceController::class, 'updateOrder']);
    ...
    Route::patch('/products/client-site', [AdminProductController::class, 'bulkClientSite']);
    ...
    Route::get('/partner-wallets', [AdminPartnerFinanceController::class, 'wallets']);
    Route::post('/partner-wallets/{partner}/adjust', [AdminPartnerFinanceController::class, 'adjustWallet']);
    Route::post('/partner-wallets/{partner}/status', [AdminPartnerFinanceController::class, 'walletStatus']);
    Route::get('/partner-recharges', [AdminPartnerFinanceController::class, 'recharges']);
    Route::get('/partner-loans', [AdminPartnerFinanceController::class, 'loans']);
    Route::post('/partner-loans/{loan}/approve', [AdminPartnerFinanceController::class, 'approveLoan']);
    Route::post('/partner-loans/{loan}/reject', [AdminPartnerFinanceController::class, 'rejectLoan']);
    Route::post('/partner-loans/{loan}/extend', [AdminPartnerFinanceController::class, 'extendLoan']);
    Route::post('/partner-loans/{loan}/mark-repaid', [AdminPartnerFinanceController::class, 'markLoanRepaid']);
    Route::get('/partner-score', [AdminPartnerFinanceController::class, 'scores']);
    Route::post('/crypto/deposits/sync', [CryptoPaymentController::class, 'adminSync']);
    Route::post('/partner-score/{partner}/adjust', [AdminPartnerFinanceController::class, 'scoreAdjustment']);
    Route::get('/partners/suspended', [AdminPartnerFinanceController::class, 'suspended']);
    Route::post('/partners/{partner}/reactivate-finance', [AdminPartnerFinanceController::class, 'reactivate']);
    Route::post('/partners/{partner}/final-suspend', [AdminPartnerFinanceController::class, 'finalSuspend']);
    Route::get('/partners/{partner}/finance-logs', [AdminPartnerFinanceController::class, 'logs']);
    Route::get('/sections/{section}', [AdminController::class, 'section']);
    Route::get('/tournaments/{tournament}/registrations.pdf', AdminTournamentRegistrationPdfController::class);
    Route::get('/tournaments/{tournament}/qualified-top12.pdf', [AdminTournamentRegistrationPdfController::class, 'qualified']);
    Route::get('/tournaments/{tournament}/qualified-logos.pdf', [AdminTournamentRegistrationPdfController::class, 'qualifiedLogos']);
